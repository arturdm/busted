...
local defaultOutput = path.is_windows and 'plain_terminal' or 'utf_terminal'
...
outputHandler = outputHandlerLoader(cliArgs.output, cliArgs.opath, outputHandlerOptions)
...
local testFileLoader = require 'src.modules.test_file_loader'(busted, loaders)
